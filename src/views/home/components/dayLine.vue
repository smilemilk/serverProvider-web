<template>
    <div style="width:88%;margin-left:6%;border-top-left-radius: 8px;border-top-right-radius: 8px;" id="day_request_con"></div>
</template>
...
<script>
    ...
    export default {
        ...
        mounted () {
            ...
            document.querySelector('#day_request_con').style.height = maxHeight - 80 + 'px';
            const option = {
