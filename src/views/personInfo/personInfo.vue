...
<script>
    ...
    import ajaxPerson from '@/api/person';
    ...
    export default {
        ...
        mounted () {
            const maxHeight = window.innerHeight - document.querySelector(".main-header-con").clientHeight -
                document.querySelector(".userLoginForm").clientHeight - 20;
            document.querySelector('.personContainer').style.height = maxHeight + 'px';
        },
        methods: {
            getUser() {
